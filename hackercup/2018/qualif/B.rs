// https://www.facebook.com/codingcompetitions/hacker-cup/2018/qualification-round/problems/B
...
fn main() {
    ...
    for case in 1..=cases {
        let n: usize = read_line(&mut buffer);
        let p_0: i64 = read_lines_iter(&mut buffer, n + 1).last().unwrap();

        let height = n + (p_0 == 0) as usize;
